...
TOSTRING     = NativeObject.prototype.toString,
 ...
 * @static
 */
L.isArray = (o) => NativeArray.isArray(o);
...
var Lang   = Y.Lang,
    Native = NativeArray.prototype,

    hasOwn = NativeObject.prototype.hasOwnProperty;
...
@static
**/
YArray.each = (array = [], fn, thisObj = Y) => {
    Native.forEach.call(array, fn, thisObj);
    return Y;
};
...
Y.cached = function (source, cache, refetch) {
    ...
    return function (arg) {
        var key = arguments.length > 1 ?
                global.Array.prototype.join.call(arguments, CACHED_DELIMITER) :
                String(arg);
 ...
 * @static
 */
O = Y.Object = function (obj) {
    // We currently wrap the native Object.create instead of simply aliasing it
    // to ensure consistency with our fallback shim, which currently doesn't
    // support Object.create()'s second argument (properties). Once we have a
    // safe fallback for the properties arg, we can stop wrapping
    // Object.create().
    return NativeObject.create(obj);
};
