...
require('yui-attribute');
require('yui-base-base');
require('yui-base-pluginhost');
require('yui-classnamemanager');
require('yui-event-focus');
require('yui-node-base');
require('yui-node-style');
